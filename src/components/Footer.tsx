      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          ...
          <p className="text-primary-foreground/70 mb-4">
            Serviço de reboque e auto socorro 24h com profissionais treinados, atendimento ágil e preço justo em Itú e região.
          </p>
        ...
        <div>
          ...
          <ul className="text-primary-foreground/70 space-y-2">
            ...
            <li>• Itú - SP</li>
            <li>• Atendimento em Itú e toda a região.</li>
          </ul>
        </div>
      </div>
